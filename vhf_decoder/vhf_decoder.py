...
# Constants for VHF band
SAMPLE_RATE = 2.4e6  # Sample rate of RTL-SDR
CENTER_FREQ = 100e6  # Center frequency for VHF bands (e.g., 2-meter band)
...
def main():
    root = tk.Tk()
    root.title("VHF Signal Visualization")

    label = ttk.Label(root, text="Click below to start capturing and visualizing VHF signals:")
    label.pack(pady=10)
